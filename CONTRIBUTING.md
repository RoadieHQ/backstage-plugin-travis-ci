# Contributing to the Backstage Travis CI plugin

We want the Backstage Travis CI plugin to become the best possible Travis CI plugin for Backstage. This is an ambitious goal, and we can't do it without the support of the community.
...
The Backstage Travis CI plugin is released under the Apache 2.0 License, and original creations contributed to this repo are accepted under the same license.
...
No one likes bugs. Report bugs as an issue [here](https://github.com/RoadieHQ/backstage-plugin-travis-ci/issues/new?assignees=&labels=bug&template=bug_template.md).
...
The best way to send feedback is to file [an issue](https://github.com/RoadieHQ/backstage-plugin-travis-ci/issues/new).
...
Have you started using the Backstage Travis CI plugin. Adding your company to [ADOPTERS](https://github.com/RoadieHQ/backstage-plugin-travis-ci/blob/main/ADOPTERS.md) really helps the project.
...
See [SECURITY.md](https://github.com/RoadieHQ/backstage-plugin-travis-ci/blob/main/SECURITY.md)
